    ...
    const transactions = [
        {
            ...
            questionId: question1.id,
            type: client_1.TransactionType.BUY, // Use enum instead of 'BUY'
            source: client_1.TransactionSource.PLATFORM_MINT, // Use enum instead of 'PLATFORM_MINT'
            tokenType: client_1.TokenType.YES, // Use enum instead of 'YES'
            quantity: 500,
            pricePerToken: 1.20,
            totalAmount: 600.00,
        ...
        },
        {
            ...
            source: client_1.TransactionSource.PLATFORM_MINT,
            tokenType: client_1.TokenType.NO, // Use enum instead of 'NO'
            quantity: 300,
            pricePerToken: 1.90,
            totalAmount: 570.00,
        ...
        },
        {
            ...
            type: client_1.TransactionType.BUY,
            source: client_1.TransactionSource.PLATFORM_MINT,
            tokenType: client_1.TokenType.NO,
            quantity: 1000,
            pricePerToken: 0.65,
            totalAmount: 650.00,
